...
#define PINGROUPS	\
	...
	PINGROUP(ATC,	PI5,		NAND,	IDE,		NAND,		GMI,		RSVD,		IDE,		0x14,	2,	0x80,	22,	0xA0,	4),\
	...
	PINGROUP(I2CP,	PZ6,		SYS,	I2C,		I2C,		RSVD,		RSVD,		RSVD4,		0x14,	18,	0x88,	8,	0xA4,	2),\
	...
	PINGROUP(KBCA,	PR0,		SYS,	KBC,		NAND,		RSVD,		RSVD,	        KBC,		0x14,	22,	0x88,	10,	0xA4,	8),\
	PINGROUP(KBCB,	PR7,		SYS,	KBC,		NAND,		SDIO2,		RSVD,		KBC,		0x14,	21,	0x88,	12,	0xA4,	10),\
	PINGROUP(KBCC,	PQ0,		SYS,	KBC,		NAND,		TRACE,		RSVD,	        KBC,		0x18,	26,	0x88,	14,	0xA4,	12),\
	PINGROUP(KBCD,	PR3,		SYS,	KBC,		NAND,		SDIO2,		RSVD,		KBC,		0x20,	10,	0x98,	26,	0xA4,	14),\
	PINGROUP(KBCE,	PQ7,		SYS,	KBC,		NAND,		OWR,		RSVD,		KBC,		0x14,	26,	0x80,	28,	0xB0,	2),\
	PINGROUP(KBCF,	PQ2,		SYS,	KBC,		NAND,		TRACE,		RSVD,		KBC,		0x14,	27,	0x80,	26,	0xB0,	0),\
	...
	PINGROUP(UAC,	PV0,		BB,	OWR,		RSVD,		RSVD,		RSVD4,		RSVD4,		0x18,	20,	0x80,	4,	0xAC,	4),\
	PINGROUP(UAD,	PC2,		UART,	UARTB,		SPDIF,		UARTA,		SPI4,		SPDIF,		0x18,	21,	0x80,	6,	0xAC,	6),\
